...
const CONFIG = {
    ...
    valentineName: "Lê Nguyễn Hạnh Ngân",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Chúc mừng Valentine vợ iuuuu 💝",
    ...
    questions: {
        ...
        second: {
            ...
            startText: "Rất rất nhìu lunnnn",                                   // Text before the percentage
            nextBtn: "Nhấn vào đây nè bé ❤️"                                         // Text for the next button
        },
        third: {
            text: "Anh mong Valentine năm sau mình sẽ ở cùng nhau 🌹", // The big question!
            yesBtn: "Đồng ý nè",                                             // Text for "Yes" button
